    ...
    stationary = {
        ...
        generate = function(health, level, windowW, windowH)
            ...
            return {
                ...
                shootInterval = 0.5 + math.random() * 0.15,
            }
        end,
    },
    orbit = {
    ...
    stationary_boss = {
        ...
        generate = function(health, level, windowW, windowH)
            ...
            return {
                ...
                shootInterval = 0.8 + math.random() * 0.4,
...
local levels = {
    ...
    [2] = {
        ...
        windowHeight = 800,
        enemies = {
            { movementType = "stationary", x = 400, y = 500, health = 45, shootPattern = "cone", projectileCount = 2, shootInterval = 0.55 },
        },
    },
    [3] = {
        timeLimitSeconds = 20,
        ...
        windowHeight = 640,
        enemies = {
            { movementType = "stationary", x = 500, y = 300, health = 30, shootPattern = "cone", projectileCount = 2, shootInterval = 0.5 },
    ...
    [5] = {
        ...
        windowHeight = 800,
        enemies = {
            { movementType = "stationary", x = 500, y = 300, health = 45, shootPattern = "cone", projectileCount = 1, shootInterval = 0.5 },
