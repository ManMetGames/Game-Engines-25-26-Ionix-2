...
local STRINGS = {
  en = {
    ...
    ["gameover.summary"] = "RUN SUMMARY",
        ...
        ["summary.firerate"] = "Fire Rate: +",
        ["summary.nowitnesses"] = "No Witnesses: ",
        ["summary.healingorbs"] = "Healing Orbs: +",
        ["summary.antivirus"] = "Antivirus: ",
        ["summary.overhealth"] = "Overhealth: ",
        ["summary.chainhits"] = "Chain Hits: ",
        ["summary.score"] = "Score",
        ["summary.totalxp"] = "Total XP",
        ["summary.difficulty"] = "Difficulty",

    ["menu.bestscore"] = "Best Score: ",
    ["leaderboard.score"] = "%d pts",
  ...
  ja = {
    ...
    ["gameover.summary"] = "リザルト",
        ...
        ["summary.maxhp"] = "最大HP: ",
        ["summary.firerate"] = "発射速度: +",
        ["summary.nowitnesses"] = "口封じ: ",
        ["summary.healingorbs"] = "回復オーブ: +",
        ["summary.antivirus"] = "アンチウイルス: ",
        ["summary.overhealth"] = "オーバーヘルス: ",
        ["summary.chainhits"] = "連鎖攻撃: ",
        ["summary.score"] = "スコア",
        ["summary.totalxp"] = "合計XP",
        ["summary.difficulty"] = "難易度",

    ["menu.bestscore"] = "最高スコア: ",
    ["leaderboard.score"] = "%d点",
