  ...
  en = {
    ...
    ["gameplay.resuming"] = "Starting...",
        ...
        ["upgradetype.no_witnesses"] = "No Witnesses",
            ["upgradedesc.no_witnesses"] = "Deal massive damage when few enemies remain (1 enemy at Rank 1, 3 or less at Rank 2).",
            ["upgradedesc.no_witnesses_rank1"] = "Deal massive damage when only one enemy is left.",
            ["upgradedesc.no_witnesses_rank2"] = "Deal massive damage when 3 or less enemies are left.",
  ...
  ja = {
    ...
    ["gameplay.resuming"] = "再開中．．．",
        ...
        ["upgradetype.overhealth"] = "オーバーヘルス",
            ["upgradedesc.overhealth"] = "最大HPを超えた回復はオーバーヘルスになり、周囲の敵にダメージを与える電気サークルが発動する",
    ["pause.title"] = "一時停止",
    ["pause.resume"] = "再開",
    ["pause.quit"] = "メインメニューへ",
