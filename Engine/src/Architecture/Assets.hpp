...
struct Textures {
    ...
    uint32_t Beach_Tile = 2261312692u;
    uint32_t Chest = 2964157630u;
    uint32_t Cliff_Tile = 1162049282u;
    uint32_t Coin = 2929616156u;
    uint32_t Cube = 2849387920u;
    uint32_t Debug = 2430642766u;
    uint32_t FarmLand_Tile = 182260368u;
    ...
    uint32_t Grass_Middle = 1190802146u;
    uint32_t Path_Middle = 651115730u;
    uint32_t Path_Tile = 2724445068u;
    uint32_t PimBall = 3518613816u;
    uint32_t Sand = 2995081222u;
    uint32_t Test = 510180426u;
    uint32_t Triangle = 801038052u;
    uint32_t Water_Middle = 690208212u;
    uint32_t Water_Tile = 2547935338u;
    ...
    inline std::map<std::string, std::string> GetTextures() {
        ...
        map["Beach_Tile"] = "./Assets/Beach_Tile.png";
        map["Chest"] = "./Assets/Chest.png";
        map["Cliff_Tile"] = "./Assets/Cliff_Tile.png";
        map["Coin"] = "./Assets/Coin.png";
        map["Cube"] = "./Assets/Cube.jpg";
        map["Debug"] = "./Assets/Debug.png";
        map["FarmLand_Tile"] = "./Assets/FarmLand_Tile.png";
        ...
        map["Grass_Middle"] = "./Assets/Grass_Middle.png";
        map["Path_Middle"] = "./Assets/Path_Middle.png";
        map["Path_Tile"] = "./Assets/Path_Tile.png";
        map["PimBall"] = "./Assets/PimBall.png";
        map["Sand"] = "./Assets/Sand.png";
        map["Test"] = "./Assets/Test.png";
        map["Triangle"] = "./Assets/Triangle.png";
        map["Water_Middle"] = "./Assets/Water_Middle.png";
        map["Water_Tile"] = "./Assets/Water_Tile.png";
